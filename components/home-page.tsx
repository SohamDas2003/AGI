  ...
  const skills = [
    {
      ...
      description: "Subject-specific knowledge and technical proficiency in chosen field",
    },
    {
    ...
    },
    {
      ...
      description: "Computer literacy, software proficiency and technology adaptation",
    },
    {
      icon: <Users2 className="w-6 h-6" />,
      title: "Interpersonal Skills",
      description: "Teamwork, leadership, conflict resolution and emotional intelligence",
    },
    {
      icon: <Lightbulb className="w-6 h-6" />,
      title: "Creativity",
      description: "Innovation, problem-solving and creative thinking abilities",
    },
  ]

  const programs = ["MBA", "MCA", "PGDM", "BMS", "B.Arch.", "BFA Applied Art", "B.Voc. Interior Design", "M.Arch"]

  const features = [
    {
      icon: <Users className="w-8 h-8" />,
      title: "Bulk Student Registration",
      description: "Excel file upload for automatic profile creation and batch processing",
    },
    {
      icon: <BarChart3 className="w-8 h-8" />,
      title: "Comprehensive Analytics",
      description: "Real-time performance metrics, placement analytics and detailed reporting",
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: "Skill-Based Assessment",
      description: "Evaluate students across 5 core competencies with detailed feedback",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Placement Recommendations",
      description: "AI-driven placement suggestions based on comprehensive skill evaluation",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Aditya Group Of Institutions</h1>
                <p className="text-xs text-gray-500">Placement Assessment Platform</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Comprehensive web-based platform designed for educational institutes to assess students across 5 key
                  skill areas and provide detailed analytics for both students and administrators.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl font-semibold text-gray-900">Assessment Dashboard</h3>
                  ...
                  <div className="space-y-4">
                    {skills.slice(0, 3).map((skill, index) => (
                      <div key={index} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-sm text-gray-600">{85 - index * 10}%</div>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive tools for student assessment, management, and placement analytics
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">5 Core Skills Assessment</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive evaluation across key competencies that matter most for placement success
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-8 rounded-2xl text-white md:col-span-2 lg:col-span-1">
              ...
              <p className="text-blue-100 mb-4">
                Get detailed insights and placement recommendations based on all skill assessments combined.
              </p>
      ...
      <section id="programs" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Supported Programs</h2>
            <p className="text-xl text-gray-600">Assessment platform designed for diverse academic programs</p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Trusted by educational institutions across the country</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">Ready to Transform Your Placement Process?</h2>
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Join educational institutions that are already using our platform to enhance student placement outcomes
            through comprehensive skill assessment.
          </p>
      ...
      <footer id="contact" className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">Aditya Group Of Institutions</h3>
                  <p className="text-gray-400 text-sm">Placement Assessment Platform</p>
                </div>
              </div>
              <p className="text-gray-400 mb-6 max-w-md">
                Empowering educational institutions with comprehensive student assessment and placement analytics for
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2025 Aditya Group Of Institutions. All rights reserved.</p>
